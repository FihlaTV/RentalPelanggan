...
public class TabStatus4 extends Fragment {
    ...
    public void getDataPemesanan() {
        try {
            ...
            mDatabase.child("pemesananKendaraan").child(status4).orderByChild("idPelanggan").equalTo(idPelanggan).addValueEventListener(new com.google.firebase.database.ValueEventListener() {
                @Override
